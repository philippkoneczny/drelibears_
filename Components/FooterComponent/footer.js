...
function Footer() {
     return (
          <div className="footer">
               <div className="first">
                    <div className="col1">
                         <div className="headlinefoot row11">SHOP</div>
                         <div className="row22 borderfoot"></div>
                         <div className="row33">Bären und Drachen</div>
                         <div className="row44">Baby- und Kinderbekleidung</div>
                         <div className="row55">Accessoires</div>
                    </div>
               ...
               <div className="secondfoot">
                    ...
                    <div className="col1">
                         ...
                         <div className="row22 borderfoot"></div>
                         <div className="row33">Facebook</div>
                         <div className="row44">Instagram</div>
                         <div className="row55"></div>
                    </div>
               ...
               <div className="thirdfoot">
                    <div className="borderline"></div>
                    <div className="col1">
                         <div className="row11 rights">© 2021 All rights Reserved. Design by Philipp Koneczny</div>
                    </div>
